...
const PERMISSIONS = {
  ...
  // Gestion des projets (directeur : consultation uniquement)
  CREATE_PROJECT: [ROLES.ADMIN, ROLES.COORDINATOR, ROLES.PROJECT_MANAGER],
  UPDATE_PROJECT: [ROLES.ADMIN, ROLES.COORDINATOR, ROLES.PROJECT_MANAGER],
  DELETE_PROJECT: [ROLES.ADMIN, ROLES.COORDINATOR, ROLES.PROJECT_MANAGER],
  ...
  // Gestion des tâches (directeur : pas d'accès)
  CREATE_TASK: [ROLES.ADMIN, ROLES.COORDINATOR, ROLES.PROJECT_MANAGER],
  UPDATE_TASK: [ROLES.ADMIN, ROLES.COORDINATOR, ROLES.PROJECT_MANAGER, ROLES.TEAM_MEMBER],
  DELETE_TASK: [ROLES.ADMIN, ROLES.COORDINATOR, ROLES.PROJECT_MANAGER],
  VIEW_TASK: [ROLES.ADMIN, ROLES.COORDINATOR, ROLES.PROJECT_MANAGER, ROLES.TEAM_MEMBER, ROLES.CLIENT],
  ASSIGN_TASK: [ROLES.ADMIN, ROLES.COORDINATOR, ROLES.PROJECT_MANAGER],

  // Gestion des devis
  CREATE_QUOTE: [ROLES.ADMIN, ROLES.DIRECTOR],
  UPDATE_QUOTE: [ROLES.ADMIN, ROLES.DIRECTOR],
  DELETE_QUOTE: [ROLES.ADMIN, ROLES.DIRECTOR],
  ...
  DELETE_INVOICE: [ROLES.ADMIN, ROLES.DIRECTOR],
